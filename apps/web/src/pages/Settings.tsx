        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description: 'Xem các thiết bị đăng nhập gần đây',
                    action: 'navigate',
                ...
                },
                {
                    ...
                    description: 'Tạm khóa tài khoản và có thể mở lại sau',
                    action: 'navigate',
                    ...
                    <div key={section.title} className="card p-0 overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-100 dark:divide-gray-800">
                            {section.items.map((item) => (
                                <button
                                    key={item.label}
                                    className={`w-full flex items-center justify-between px-4 py-4 hover:bg-gray-50 dark:hover:bg-dark-300 transition-colors ${
                                        item.danger
